...
public class FilaListaAdaptador2 extends BaseAdapter {
	
	private String[] id;
	private String[] filas;
	
	public FilaListaAdaptador2(Context contexto, int id_recurso, String[] filas, String[] ids){
		this.filas=filas;
		this.id=ids;
	}
	...
	public View getView(int posicion, View vista_conversion, ViewGroup padre) {
		...
		if (vista_conversion == null) {
			...
			vista_fila = inflador.inflate(R.layout.fila_lista2,null);
		} else {
